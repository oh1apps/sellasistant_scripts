...
function get_sa_order($order_id)
{
    ...
    if ($http_code == 200) {
        ...
        echo ("Nie udało się pobrać zamówienia $order_id: $http_code: $response");
        exit();
    }
}
...
function update_order($update, $order_id)
{
    ...
    if ($http_code == 200) {
        ...
        echo ("Nie udało się zaktualizować zamówienia $order_id: $http_code: $response");
